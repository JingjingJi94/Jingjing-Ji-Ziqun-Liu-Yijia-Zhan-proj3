...
const Nav = ({ children, isLoggedIn, username, onLogout }) => {
          ...
          {!isLoggedIn ? (
            <>
              <li>
                <Link
                  to="/login"
                  className={`navbar-link ${location.pathname === "/login" ? "selected" : ""}`}
                >
              ...
              <li>
                <Link
                  to="/register"
                  className={`navbar-link ${location.pathname === "/register" ? "selected" : ""}`}
                >
            ...
            <>
              <li className="navbar-link"> {username}</li>
              <li>
